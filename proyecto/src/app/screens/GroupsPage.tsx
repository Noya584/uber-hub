...
export function GroupsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'mapa' | 'gastos'>('mapa');
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 56px)' }}>
      ...
      <div className="h-10 bg-black border-b border-white/10 flex items-center justify-between px-4 flex-shrink-0">
        ...
        <Button
          className="h-7 bg-black border border-white/20 hover:bg-white/10 text-xs text-white"
      ...
      <div className="flex flex-1 overflow-hidden bg-black text-white">
        ...
        {/* Centro — Mapa o Gastos con pestañas abajo */}
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Pestañas abajo centradas */}
          <div className="flex-shrink-0 flex justify-center pb-3 pt-2 bg-black border-t border-white/10">
