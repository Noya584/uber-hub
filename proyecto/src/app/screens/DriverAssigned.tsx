      ...
      <Dialog open onOpenChange={() => navigate('/grupos')}>
        <DialogContent className="bg-[#1a1a1a] border-white/10 max-w-md">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-medium mb-1">Viaje confirmado para Sofía</h2>
            <p className="text-sm text-white/60 mb-6">Se notificó a Sofía por SMS</p>
            ...
            <div className="w-full">
              <div className="flex items-center gap-4 mb-4">
                <Avatar className="w-16 h-16">
                  <AvatarFallback className="bg-[#06C167] text-lg">CM</AvatarFallback>
                </Avatar>
